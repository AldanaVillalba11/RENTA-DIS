...
public final class FrmMantenerCargos extends javax.swing.JFrame {

    ArriendosDao arDao = new ArriendosDao();
    DefaultTableModel modelo = new DefaultTableModel();

    public FrmMantenerCargos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblMantenerArriendos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "FECHA", "MONTO", "USUARIO", "COMENTARIOS"
            }
        ) {
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        LimpiarTable();
        listarCargos(txtBuscar.getText());
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        FrmCargosArriendos menu = new FrmCargosArriendos();
        menu.setVisible(true);
        dispose();
    ...
    public void listarCargos(String valorBusqueda) {
        List<Cargos> lista = arDao.listarCargos(valorBusqueda);
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            ob[4] = lista.get(i).getComentarios();
            modelo.addRow(ob);
        }
