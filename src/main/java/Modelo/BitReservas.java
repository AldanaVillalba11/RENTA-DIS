...
public class BitReservas {
    ...
    public BitReservas(int id, String fecha_hora, String accion, String campo, String valor_ant, String valor_nuevo, int id_cliente, int id_usuario, String cliente, String usuario) {
        this.id = id;
